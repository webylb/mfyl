  ...
  data() {
    return {
      ...
      myConfig: {
        ...
        UEDITOR_HOME_URL: process.env.NODE_ENV === 'production' ?  (process.env.VUE_APP_TITLE==='MFYL_PRODUCTION' ? 'https://bea.guijitech.com/static/' : 'https://prev-bea.guijitech.com/static/') : '/UEditor/',
