<template>
  <div class="category-recommend">
    ...
    <el-form ref="form" :inline="true" label-position="center" label-width="80px">
      <el-form-item>
        <el-button type="primary" icon="el-icon-plus" @click="addGoods(1)">添加品类</el-button>
        <el-button type="primary" @click="addSecondGoods()">添加二级品类</el-button>
      </el-form-item>
    </el-form>
...
export default {
  ...
  created(){
    this.getHomeFirstIcon()
  },
  methods: {
    getHomeFirstIcon(){
      core.getHomeFirstIcon().then(res => {
